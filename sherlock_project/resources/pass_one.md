...
{"reasoning":"include Hana Okonkwo as full_name — Description and Profile biography say where it was found, not what it is. skip: @tallowbird is the searched username, and the counts are telemetry. include Ceramics teacher as roles and Kiln & Co as organizations, splitting the line. include Volunteer archivist as roles and @stonebridgemuseum as organizations, an associated account rather than the owner's handle. include Igbo and Portuguese as languages, the last biography line.","extraction":{"full_name":["Hana Okonkwo"],"roles":["Ceramics teacher","Volunteer archivist"],"organizations":["Kiln & Co","@stonebridgemuseum"],"languages":["Igbo","Portuguese"]}}
...
{"reasoning":"skip: the Title is the platform and the searched username. skip: the tagline describes Chirp, not its user. skip: keeping quiet for now is an empty state. skip: a reply describes Dr. Yusuf Adeyemi, not the owner. Nothing about the owner remains.","extraction":{}}
